---
tags: ["networking", "packet tracer", "cisco", "infrastructure"]
status: "Completed"
---
...
The network is segregated into multiple VLANs (Virtual Local Area Networks) to ensure optimal traffic flow and strict security boundaries between departments (e.g., HR, Engineering, and Guest).
...
*(This is a high-fidelity placeholder designed to showcase network engineering expertise in the portfolio gallery.)*
